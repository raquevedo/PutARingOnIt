...
;BEGIN AUTOCAST TYPE AUSITriggerCourierOnUpdate
Quest __temp = self as Quest
AUSITriggerCourierOnUpdate kmyQuest = __temp as AUSITriggerCourierOnUpdate
;END AUTOCAST
;BEGIN CODE
RegisterForSingleUpdateGameTime(1) ; Wait 7 days and then trigger Courier Event
;END CODE
EndFunction
;END FRAGMENT
...
Alias_QuestGiver.GetReference().AddItem(Alias_Ring.GetReference())
